...
if __name__ == "__main__":
    ...
    PATTERNS = 'patterns/AR/patterns_all_bracoAR3isom'
    fid = open(PATTERNS, 'r')
    lines = fid.readlines()
    fid.close()
    alpha = 0.1
...
############### Sempre alterar aqui também
    ...
    ############### Sempre alterar aqui também            
            ...
            #            print 'Total vector: ', total_vector
                ...
                fid = open('results/res_AR3_'+str(n_hidden_neurons)+'_'+str(tolerance)+'.dat','a')
                ...
                fid = open('results/res_AR3_'+str(n_hidden_neurons)+'_'+str(tolerance)+'.dat','r')

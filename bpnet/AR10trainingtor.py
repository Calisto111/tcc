...
if __name__ == "__main__":
    ...
    PATTERNS = 'patterns/AR/patterns_all_bracoAR10isom'
    fid = open(PATTERNS, 'r')
    lines = fid.readlines()
    fid.close()
    alpha = 0.1
...
############### Sempre alterar aqui também
        patterns = line.split()
        training_set.append( ([float(patterns[0]), float(patterns[1]), float(patterns[2]), float(patterns[3]), float(patterns[4]), float(patterns[5]), float(patterns[6]), float(patterns[7]), float(patterns[8]), float(patterns[9])], [int(patterns[10]), int(patterns[11]), int(patterns[12]), int(patterns[13]), int(patterns[14])]))
    for n in range(20,21,1):

        n_hidden_neurons = n
        shuffle(training_set)
        training_setx = []
        for tolerance in range(100,301,50):
            for i in range(110):
    ...
    ############### Sempre alterar aqui também
                for line in lines:
                    patterns = line.split()
                    test_set.append([float(patterns[0]), float(patterns[1]), float(patterns[2]), float(patterns[3]), float(patterns[4]), float(patterns[5]), float(patterns[6]), float(patterns[7]), float(patterns[8]), float(patterns[9])])
                    result_set.append([int(patterns[10]), int(patterns[11]), int(patterns[12]), int(patterns[13]), int(patterns[14])])

                correct = 0
                total = 0
    ############### Sempre alterar aqui também            
                correct_vector = [0 for i in range(62)]
                total_vector =[0 for i in range(62)]
            ...
            #            print 'Total vector: ', total_vector
                ...
                fid = open('results/res_AR10_'+str(n_hidden_neurons)+'_'+str(tolerance)+'.dat','a')
                ...
                fid = open('results/res_AR10_'+str(n_hidden_neurons)+'_'+str(tolerance)+'.dat','r')

...
PATTERNS_PATH=['/home/dantutu/Documents/Mestrado/ProjetoFinal/netscompair/Mattioli/netComp_src/testes/realized tests/teste1.7']
...
for filename in new_list:
    ...
    fid = open('results/results_performance_n_clusters.dat', 'a')
    ...
    fid = open('results/results_time_n_clusters.dat', 'a')

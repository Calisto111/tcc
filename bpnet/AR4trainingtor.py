...
if __name__ == "__main__":
    ...
    PATTERNS = 'patterns/AR/patterns_all_bracoAR4isom'
    fid = open(PATTERNS, 'r')
    lines = fid.readlines()
    fid.close()
    alpha = 0.1
...
############### Sempre alterar aqui também
        patterns = line.split()
        training_set.append( ([float(patterns[0]), float(patterns[1]), float(patterns[2]), float(patterns[3])], [int(patterns[4]), int(patterns[5]), int(patterns[6]), int(patterns[7]), int(patterns[8])]))
    ...
    ############### Sempre alterar aqui também
                for line in lines:
                    patterns = line.split()
                    test_set.append([float(patterns[0]), float(patterns[1]), float(patterns[2]), float(patterns[3])])
                    result_set.append([int(patterns[4]), int(patterns[5]), int(patterns[6]), int(patterns[7]), int(patterns[8])])
    ...
    ############### Sempre alterar aqui também            
            ...
            #            print 'Total vector: ', total_vector
                ...
                fid = open('results/res_AR4_'+str(n_hidden_neurons)+'_'+str(tolerance)+'.dat','a')
                ...
                fid = open('results/res_AR4_'+str(n_hidden_neurons)+'_'+str(tolerance)+'.dat','r')

...
if __name__ == "__main__":
    ...
    PATTERNS = 'patterns/AR/patterns_all_bracoAR8isom'
    fid = open(PATTERNS, 'r')
    lines = fid.readlines()
    fid.close()
    alpha = 0.1
...
############### Sempre alterar aqui também
        patterns = line.split()
        training_set.append( ([float(patterns[0]), float(patterns[1]), float(patterns[2]), float(patterns[3]), float(patterns[4]), float(patterns[5]), float(patterns[6]), float(patterns[7])], [int(patterns[8]), int(patterns[9]), int(patterns[10]), int(patterns[11]), int(patterns[12])]))
    ...
    ############### Sempre alterar aqui também
                for line in lines:
                    patterns = line.split()
                    test_set.append([float(patterns[0]), float(patterns[1]), float(patterns[2]), float(patterns[3]), float(patterns[4]), float(patterns[5]), float(patterns[6]), float(patterns[7])])
                    result_set.append([int(patterns[8]), int(patterns[9]), int(patterns[10]), int(patterns[11]), int(patterns[12])])
    ...
    ############### Sempre alterar aqui também            
            ...
            #            print 'Total vector: ', total_vector
                ...
                fid = open('results/res_AR8_'+str(n_hidden_neurons)+'_'+str(tolerance)+'.dat','a')
                ...
                fid = open('results/res_AR8_'+str(n_hidden_neurons)+'_'+str(tolerance)+'.dat','r')

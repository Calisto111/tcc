...
PATTERNS_PATH=['/home/dantutu/Documents/Mestrado/ProjetoFinal/netscompair/Mattioli/netComp_src/testes/realized tests/testes1.9/hidden_neurons/1']
...
for filename in new_list:
    ...
    fid = open('AR10results_performance_hidden_neurons.dat', 'a')
    ...
    fid = open('AR10results_time_hidden_neurons.dat', 'a')

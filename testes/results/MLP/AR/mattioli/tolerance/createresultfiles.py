...
PATTERNS_PATH=['/home/dantutu/Documents/Mestrado/ProjetoFinal/netscompair/Mattioli/netComp_src/testes/realized tests/testes1.9/tolerance']
...
for filename in new_list:
    ...
    fid = open('AR8results_performance_tolerance.dat', 'a')
    ...
    fid = open('AR8results_time_tolerance.dat', 'a')

...
# set output 'tl_comp_traintime_AR.eps'
 ...
 set title 'Treinamento da rede MLP'
...
#Time line comparative training time tolerance
...
#Time line comparative eficient alpha
 ...
 set xlabel 'Alpha'
 set ylabel "E(%) \n Eficiencia"
 set title 'Eficiencia da rede MLP em funcao de Alpha'
# set style fill solid 0.05 

 plot './alpha/AR3results_performance_alpha.dat' u 1:($2*100) w lines lc 1 title "AR3", './alpha/AR4results_performance_alpha.dat' u 1:($2*100) w lines lc 2 title "AR4", './alpha/AR6results_performance_alpha.dat' u 1:($2*100) w lines lc 3 title "AR6", './alpha/AR8results_performance_alpha.dat' u 1:($2*100) w lines lc 4 title "AR8", './alpha/AR10results_performance_alpha.dat' u 1:($2*100) w lines lc 5 title "AR10"
...
#Traning Time Process Cluster/AR
 ...
 set ylabel "E(%) \n Eficiencia"
 set title 'Eficiencia da rede MLP em funcao da tolerancia'
# set style fill solid 0.05 

 plot './tolerance/AR3results_performance_tolerance.dat' u 1:($2*100) w lines lc 1 title "AR3", './tolerance/AR4results_performance_tolerance.dat' u 1:($2*100) w lines lc 2 title "AR4", './tolerance/AR6results_performance_tolerance.dat' u 1:($2*100) w lines lc 3 title "AR6", './tolerance/AR8results_performance_tolerance.dat' u 1:($2*100) w lines lc 4 title "AR8", './tolerance/AR10results_performance_tolerance.dat' u 1:($2*100) w lines lc 5 title "AR10"

#--------------------------------------------------------------------------------------------------------------------------------

#Time line comparative eficient alpha
 set output 'tl_compefic_hidden_neurons_AR.eps'
 set xrange [0.1:0.7]
 set yrange [0.0:100]
 set xlabel 'Alpha'
 set ylabel "E(%) \n Eficiencia"
...
#--------------------------------------------------------------------------------------------------------------------------------
#Traning Time Process Cluster/AR
 set output 'tl_compefic_tolerance_hidden_neurons.eps'
 set xrange [100:300]
 set yrange [0:100]
 set xlabel 'Tolerancia'
 set ylabel "E(%) \n Eficiencia"

...
# Performance - Alpha
 ...
 set output 'isot1par_performance_alpha.eps'
...
# Performance - Dec. Alpha
 ...
 set output 'isot1par_performance_dec_alpha.eps'
 set xrange [0.01:0.91]
 set yrange [71:81]
...
# Execution time - Alpha
 set terminal postscript enhanced font "Helvetica" 18
 set output 'isot1par_ex_time_alpha.eps'
 set xrange [0.01:0.91]
 set yrange [350:900]
...
# Execution time - Dec. Alpha
 ...
 set terminal postscript enhanced font "Helvetica" 18
 set output 'isot1par_ex_time_dec_alpha.eps'
 set xrange [0.01:0.91]
 set yrange [170:4075]
...
# Performance - Tolerance
 ...
 set terminal postscript enhanced font "Helvetica" 18
 set output 'isot1par_performance_tolerance.eps'
...
# Execution time - Tolerance
 ...
 set output 'isot1par_ex_time_tolerance.eps'
 set xrange [0.001:0.091]
 set yrange [90:580]
...
# Performance - N. clusters
 ...
 set terminal postscript enhanced font "Helvetica" 18
 set output 'isot1par_performance_clusters.eps'
 set xrange [24:240]
 set yrange [42:82]
...
# Execution time - Training N. clusters
 ...
 set terminal postscript enhanced font "Helvetica" 18
 set output 'isot1par_time_training_clusters.eps'
 set xrange [24:240]
 set yrange [200:670]

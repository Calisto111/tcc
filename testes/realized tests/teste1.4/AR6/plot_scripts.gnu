...
# Performance - Alpha
 ...
 set yrange [0.23:0.57]
 set xlabel 'Coeficiente de aprendizagem (alpha)'
 set ylabel 'E (%)'
 set title 'Eficiência da rede LVQ com AR6 - (E)'
...
# Execution time - Alpha
 ...
 set title 'Treinamento da rede LVQ com AR6'
# set grid
 set xtic offset 0.5
...
#set ylabel 'Tempo de execução (s)'
#set title 'reinamento da rede LVQ com AR6'

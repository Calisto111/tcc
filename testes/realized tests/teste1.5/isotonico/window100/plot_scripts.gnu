...
# set yrange [0.22:0.33]
# set xlabel 'Coeficiente de aprendizagem (alpha)'
# set ylabel 'E (%)'
# set title 'Eficiência da rede LVQ com AR10 - (E)'
...
# set title 'Treinamento da rede LVQ com AR10 '
# set grid
# set xtic offset 0.5
